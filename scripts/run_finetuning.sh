# training script for training zero-shot model and fine-tuning models
QLANG=$1
DLANG=$2
SEED=$3
...
DATA_HOME=/path/to/data_home/finetuning/$QLANG$DLANG
OUT=/path/to/model_home/finetuning/seed\_$SEED/$QLANG$DLANG
